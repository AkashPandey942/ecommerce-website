...
export default function AccessoriesApprovePrimePage() {
  ...
  const getPrimeImage = () => {
    if (style === "bags") return "/assets/categories/handbag.png";
    if (style === "footwear") return "/assets/categories/footwear.png";
    if (style === "watches") return "/assets/categories/watch.png";
    return "/assets/categories/handbag.png";
  };
        ...
        <AnimatePresence mode="wait">
          {isGenerating ? (
            ...
            >
              ...
              {/* Section 6.7: Feedback / Refinement */}
              <section className="w-full max-w-[400px] mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-2">
                    <h3 className="font-semibold text-xl">Improve Result</h3>
                  </div>
                  ...
                  {showTextBox && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="overflow-hidden mb-8">
                      <textarea 
                        ...
                        placeholder="E.g. Make the leather look more pebbled..."
                      />
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button 
                    ...
                    className="w-full h-[54px] rounded-xl border border-white/10 bg-white/5 flex items-center justify-center gap-2 hover:bg-white/10 transition-all text-white/60"
                  >
