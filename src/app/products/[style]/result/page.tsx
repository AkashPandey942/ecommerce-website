...
import { Download, Share2, CornerUpRight, LayoutTemplate } from "lucide-react";
...
export default function ProductsResultPage() {
  ...
  const results = [
    { id: 1, type: "Prime shot", image: "/home_products.png" },
    { id: 2, type: "Side Angle", image: "/home_products.png" },
    { id: 3, type: "Top Down", image: "/home_products.png" },
    { id: 4, type: "Contextual", image: "/home_products.png" },
  ];
      ...
      <main className="w-full max-w-lg lg:max-w-7xl mx-auto pt-[120px] px-5 flex flex-col">
        ...
        <section className="mt-8 mb-12 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <h1 className="text-3xl lg:text-4xl font-bold text-white mb-2">Assets Ready!</h1>
            <p className="text-[#99A1AF]">Your professional {product} photoshoot is complete.</p>
          </motion.div>
