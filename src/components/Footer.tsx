...
const Footer = () => {
  return (
    <footer className="w-full bg-[#030014] border-t border-[#2F2751] pt-12 pb-[110px] lg:pb-10 px-5">
      <div className="max-w-7xl mx-auto">
        {/* Main Footer Content */}
        <div className="flex flex-col lg:flex-row justify-between gap-10 mb-10">
          <div className="flex flex-col gap-4">
            <BrandLogo />
            <p className="font-inter text-sm text-[#9CA3AF] max-w-xs">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="flex flex-col gap-2 font-inter text-sm text-[#9CA3AF]">
